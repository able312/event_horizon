...
const ALLOWED_INVOKE_CHANNELS = new Set([
  ...
  "contact-roles:get-by-contact-id",
  "contacts:archive",
  "contacts:delete",
  ...
  "timeblocks:convert-section-type",
  "timeblocks:delete",
  "timeblocks:get-by-event-and-section",
  "timeblocks:get-all-timeline-blocks",
  "timeblocks:get-by-id",
  "timeblocks:inspect-conversion",
  "timeblocks:patch",
  "timeblocks:post",
  ...
  "vendor-categories:archive",
  "vendor-categories:get-many",
